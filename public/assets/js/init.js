...
const Init = (update) => {
	...
	const item1 = $('<div></div>');
	const img1 = $('<img src="assets/img/icons/icon-people.png" class="col s10 offset-s1 m6 offset-m3">');
	...
	const item2 = $('<div></div>');
	const img2 = $('<img src="assets/img/icons/happy-person.png" class="col s10 offset-s1 m6 offset-m3">');
